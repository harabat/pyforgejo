...
def _get_discriminator_and_variants(
    type_: Type[Any],
) -> Tuple[Optional[str], Optional[List[Type[Any]]]]:
    """
...
def parse_sse_obj(sse: "ServerSentEvent", type_: Type[T]) -> T:
    ...
    if discriminator in sse_event:
        ...
        matching_variant = _find_variant_by_discriminator(
            variants, discriminator, disc_value
        )
